...
namespace rlText
{
	...
	/// </summary>
	inline bool IsPrivateUse(char32_t ch) noexcept { return rlText_IsPrivateUse(ch); }

	/// <summary>
	/// Is a value a noncharacter in Unicode?
	/// </summary>
	inline bool IsNoncharacter(char32_t ch) noexcept { return rlText_IsNoncharacter(ch); }
